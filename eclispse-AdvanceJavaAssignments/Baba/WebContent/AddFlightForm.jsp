...
<body>
    ...
    <div class="row justify-content-center align-items-center my-5">
        <div class="col-10 align-items-center mt-5">
            ...
            <br><br>
            <div class="blog-form">
                <form action="AddFlightFormDone.jsp" method="post">
                <div class="form-group form-row">
                        <label class="col-md-3"> </label>
                        <div class="col-md-9" style="display:none;">
                        
                            <input type="text" name="flightId" class="form-control" value=0
                                required>                      
                        </div>
                    </div>
                    <div class="form-group form-row">
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-md-9">
                            <input type="number" name="seatsEconomy" class="form-control" value=""
                                required>                      
                        </div>
                    </div>
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-md-9">
                            <input type="number" name="seatsBuisness" class="form-control" value=""
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="amountEconomy" class="form-control" value=""
                                required />
                        </div>
                    </div>
                     ...
                     <div class="form-group form-row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="amountBuisness" class="form-control" value=""
                                required />
                        </div>
                    </div>
